...
export const GOOGLE_LOG_IN_ERROR = 'oneroost/user/GOOGLE_LOG_IN_ERROR'
...
export const SET_SHOW_THREAD_WARNING = 'oneroost/user/SET_SHOW_THREAD_WARNING'
...
export const SET_SHOW_THREAD_WARNING_ALIAS = 'oneroost/user/SET_SHOW_THREAD_WARNING_ALIAS'
